  ...
  <div>
    ...
    >
      ...
      <el-form-item label="部门">
        <el-cascader
          v-model="from.dep"
          @change="depinfo(from.dep)"
          :options="from.deplist"
          :props="props1"
          clearable
        />
      </el-form-item>
      <el-form-item label="班级">
        <el-select
          v-model="from.query.classid"
          placeholder="请选择"
          :disabled="classname"
          clearable
        >
          <el-option
            v-for="(item, index) in from.classList"
            :label="item.name"
            :value="item.id"
            :key="index"
          />
      ...
      <div>
        ...
        >
          <div v-for="(item, index) in Dlist" :key="index">
            ...
            <!-- 回答 -->
            <p class="styles" :style="item.studentanswer == null ? 'color:red' : ''">
              回答：{{ item.studentanswer == null ? '该学员未给出答案' : item.studentanswer }}
            </p>
            <!-- 老师阅卷 -->
            <el-form-item class="margin_top">
              ...
              <el-form-item
                ...
                :prop="'Dlist.' + index + '.studentscores'"
                required
              >
                <el-input
                  style="margin-bottom: 20px; width: 200px"
                  v-model="item.studentscores"
                  type="text"
                  autocomplete="off"
                />
              </el-form-item>
