<template>
  <div class="examprepare">
    <div class="box">
      ...
      <div class="button">
        <el-button type="primary" disabled v-show="data.isshow==1?false:true">不在考试范围</el-button>
        <el-button type="primary" v-show="data.isshow==1?true:false" @click="begin">开始考试</el-button>
...
<script lang="ts" setup>
  import {getTest} from '../../api/stutest.ts'
  ...
  const GetTest1 =async ()=>{
    let res = await getTest({id:route.query.id})
    console.log(res)
