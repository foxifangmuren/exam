<template>
  <div class="examprepare">
    <div class="box">
      ...
      <div class="box_time">
        <div>用时：9分钟 | 交卷时间：{{ data.stuEndTime }} | 试卷总分：{{ data.scores }} | 通过分数：{{ data.pastscores }}</div>
      </div>
      ...
      <div class="button">
        ...
        <el-button type="warning" disabled v-else>等待阅卷</el-button>
...
import { error } from 'console';
  ...
  const {data,isShow,questionTypes,correct,error,Scores} = toRefs(obj)
</script>
