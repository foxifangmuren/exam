...
import { onBeforeUnmount,reactive, ref, shallowRef,watch,defineEmits,onMounted ,defineProps} from 'vue'
...
onMounted(()=>{
  console.log(props.data,1111111)
})
